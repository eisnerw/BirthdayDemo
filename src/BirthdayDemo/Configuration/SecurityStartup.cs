using System;
using BirthdayDemo.Infrastructure.Configuration;
using System.IdentityModel.Tokens.Jwt;
using System.Text;
using BirthdayDemo.Infrastructure.Data;
using BirthdayDemo.Domain;
using BirthdayDemo.Security;
using BirthdayDemo.Security.Jwt;
using BirthdayDemo.Domain.Services;
...
using AuthenticationService = BirthdayDemo.Domain.Services.AuthenticationService;
using IAuthenticationService = BirthdayDemo.Domain.Services.Interfaces.IAuthenticationService;
